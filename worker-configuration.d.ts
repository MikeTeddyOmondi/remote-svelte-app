/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 44b61efdbff8cbe5d1ffcb65dd08966f)
// Runtime types generated with workerd@1.20260722.1 2026-07-30 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	ORIGIN: string;
	BETTER_AUTH_SECRET: string;
	LOCCI_CLIENT_ID: string;
	LOCCI_CLIENT_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN" | "BETTER_AUTH_SECRET" | "LOCCI_CLIENT_ID" | "LOCCI_CLIENT_SECRET">> {}
}
